      ...
      <div className="flex flex-col gap-3">
        <div className="flex justify-end">
          <button
            ...
            className="inline-flex items-center gap-2 rounded-lg border border-[#e61c23]/40 bg-[#e61c23]/10 px-4 py-2 text-[0.7rem] font-bold uppercase tracking-widest text-[#e61c23] outline-none transition-colors hover:bg-[#e61c23]/20 focus-visible:ring-2 focus-visible:ring-[#e61c23]/40"
          >
