"use client";import { SavingThrowsGrid } from "@/src/components/molecules/sheet/SavingThrowsGrid";
...
import type { SheetTabPanelProps } from "./index.types";
export type { SheetTabPanelProps } from "./index.types";
