    ...
    <div className="flex flex-wrap items-center gap-3">
      ...
      <div className="inline-flex items-center gap-2 rounded-md border border-white/[0.08] bg-card px-1 py-1">
        <button type="button" aria-label="Decrease level" disabled={level <= 1}
          ...
          className="inline-flex h-10 w-10 items-center justify-center rounded text-subdued outline-none transition hover:text-foreground disabled:opacity-30 focus-visible:ring-2 focus-visible:ring-brand-crimson-alt/70">
      ...
      {pendingCount > 0 ? (
        <button type="button" onClick={() => setOpen(true)}
          className="min-h-10 rounded-md border border-brand-crimson-alt/60 bg-brand-crimson-alt/10 px-3 py-1.5 text-xs font-bold uppercase tracking-[0.08em] text-foreground outline-none transition hover:bg-brand-crimson-alt/20 focus-visible:ring-2 focus-visible:ring-brand-crimson-alt/70">
