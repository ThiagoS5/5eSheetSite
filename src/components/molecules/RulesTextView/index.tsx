...
import type { RulesInlineTextProps, RulesTextViewProps } from "./index.types";
export type { RulesInlineTextProps, RulesTextViewProps } from "./index.types";
...
export function RulesInlineText({ text }: RulesInlineTextProps) {
