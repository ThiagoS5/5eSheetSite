// forked from design-sync lib/common.mjs — add process polyfill to IIFE_IMPORT_META_DEFINE
...
export const IIFE_IMPORT_META_DEFINE = {
  ...
  // Browser doesn't have `process`. React 19 / Zustand reference it directly
  // (not just process.env.NODE_ENV which the shared define already handles).
  // Note: esbuild rejects outer parens — use bare object literal like import.meta.env does.
  'process': '{"env":{"NODE_ENV":"development"},"version":"","platform":"browser"}',
};
